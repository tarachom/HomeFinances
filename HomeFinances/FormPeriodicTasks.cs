...
namespace HomeFinances
{
    public partial class FormPeriodicTasks : Form
    {
		...
		public void LoadRecords()
		{
			...
			календарПеріодичнихЗавдань.QuerySelect.Field.Add(Довідники.КалендарПеріодичнихЗавдань_Const.Назва);
			календарПеріодичнихЗавдань.QuerySelect.Field.Add(Довідники.КалендарПеріодичнихЗавдань_Const.ПеріодВиконання);
			календарПеріодичнихЗавдань.QuerySelect.Order.Add(Довідники.КалендарПеріодичнихЗавдань_Const.Назва, SelectOrder.ASC);
			...
			while (календарПеріодичнихЗавдань.MoveNext())
			{
				...
				string періодВиконання = ((Перелічення.ПеріодиВиконанняЗавдань)cur.Fields[Довідники.КалендарПеріодичнихЗавдань_Const.ПеріодВиконання]).ToString();

				RecordsBindingList.Add(new Записи(
					cur.UnigueID.ToString(),
					cur.Fields[Довідники.КалендарПеріодичнихЗавдань_Const.Назва].ToString(),
					періодВиконання
					));
			}
        ...
        private void toolStripButtonCopy_Click(object sender, EventArgs e)
        {
				...
				MessageBox.Show("Копіювати записи?", "Повідомлення", MessageBoxButtons.YesNo) == DialogResult.Yes)
			{
				for (int i = 0; i < dataGridViewRecords.SelectedRows.Count; i++)
				{
					...
					{
						Довідники.КалендарПеріодичнихЗавдань_Objest КалендарПеріодичнихЗавдань_Objest_Новий = календарПеріодичнихЗавдань_Objest.Copy();
